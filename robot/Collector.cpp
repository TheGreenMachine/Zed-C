...
Collector::Collector(int left, int right, int motor, UINT32 IONum1,
        UINT32 IONum2) :
    collectorM(motor), deployed(IONum1), undeployed(IONum2), starR(right),
            starL(left), state(COLLECTOR_UNDEPLOYED), starDirection(1)
{
}
